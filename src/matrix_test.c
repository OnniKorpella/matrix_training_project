...
START_TEST(sum_1) {
    ...
    num_matrix(&sum_test_1_1, arr_for_sum_1_1);
    num_matrix(&sum_test_1_2, arr_for_sum_1_2);
    num_matrix(&sum_result_1_2, arr_for_sum_1_3);
...
START_TEST(sum_2) {
    ...
    num_matrix(&sum_test_2_1, arr_for_sum_2_1);
    num_matrix(&sum_test_2_2, arr_for_sum_2_2);
    num_matrix(&sum_result_2_2, arr_for_sum_2_3);
...
START_TEST(sub_2) {
    ...
    num_matrix(&sub_test_1_1, arr_for_sub_1_1);
    num_matrix(&sub_test_1_2, arr_for_sub_1_2);
    num_matrix(&sub_result_1_2, arr_for_sub_1_3);
